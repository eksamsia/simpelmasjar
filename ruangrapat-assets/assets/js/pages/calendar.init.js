...
document.addEventListener("DOMContentLoaded", function() {
        ...
        E = new FullCalendar.Calendar(e, {
            ...
            eventClick: function(e) {
                ...
                a == e ? (document.getElementById("event-time").setAttribute("hidden", !0), flatpickr(document.getElementById("timepicker1"), {
                    ...
                    dateFormat: "H:i",
                    defaultDate: e
                }), document.getElementById("event-timepicker1-tag").innerHTML = tConvert(a), document.getElementById("event-timepicker2-tag").innerHTML = tConvert(e)), newEventData = null, d.innerText = g.title, document.getElementById("btn-delete-event").removeAttribute("hidden")
            },
    ...
    E.render(), i.addEventListener("submit", function(e) {
        ...
        var u = y.length + 1;
        !1 === p[0].checkValidity() ? p[0].classList.add("was-validated") : (g ? (g.setProp("id", s), g.setProp("title", n), g.setProp("classNames", [a]), g.setStart(i), g.setEnd(l), g.setAllDay(m), g.setExtendedProp("description", r), g.setExtendedProp("location", c), s = y.findIndex(function(e) {
            return e.id == g.id
        }), y[s] && (y[s].title = n, y[s].start = i, y[s].end = l, y[s].allDay = m, y[s].className = a, y[s].description = r, y[s].location = c), E.render()) : (E.addEvent(c = {
            id: u,
            title: n,
            start: d,
            end: o,
            ...
            description: r,
            location: c
        }), y.push(c)), v.hide(), upcomingEvent(y))
