...
function detail(id){
  $.ajax({
    dataType: 'json',
    url: 'kesper/ambil-data-by-id/'+id,
    success: function ( data) {
      ...
      if(!data.data[0].imgpath){
        $("#file_kesper").attr("src","<?php echo base_url() ?>upload_file/news_image/no_image_available.jpeg");
      }
      else
      {
        $("#file_kesper").attr("src",data.data[0].imgpath);
      }
