  ...
  $.ajax({
    ...
    success: function ( data) {
      ...
      if(!data.data[0].imgpath){
        $("#file_manmu").attr("src","<?php echo base_url() ?>upload_file/news_image/no_image_available.jpeg");
      }
      else
      {
        $("#file_manmu").attr("src",data.data[0].imgpath);
      }
