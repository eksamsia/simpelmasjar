      ...
      <div class="row" data-aos="fade-up" data-aos-delay="100">
        <div class="col-lg-4 mb-5 mb-lg-0">
          <ul class="nav nav-tabs flex-column">
            ...
            $get_admen = $this->db->get('admen')->result();

            foreach ($get_admen as $val) {
              ?>
              <li class="nav-item">
                <a class="nav-link active show" data-toggle="" href="<?php echo base_url();?>detail-admen/<?= $val->id ?>">
        ...
        <div class="col-lg-8">
          <div class="tab-content">
            ...
            $this->db->where('isActive', '1');
            $this->db->order_by("id", "asc");
            $get_detadmen = $this->db->get('admen')->row();
            ?>
            <div class="tab-pane active show" id="tab-1" class="container-iframe">
              <h3><?php echo $get_detadmen->judul; ?></h3>
              <div style="--aspect-ratio: 13/9;"> 
               <?php echo $get_detadmen->isi; ?>
             </div>
           </div>
         </div>
       </div>
