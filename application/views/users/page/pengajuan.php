                ...
                <div class="col-lg-12">
                    <div class="">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <button type="button" class="btn btn-warning" onclick="get_data()"><i
                                            class="las la-server"></i> Get Data</button>
                                    <div id='calendar'></div>
                ...
                <div class="modal-body">
                    ...
                    <form id="form_input">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label for="teammembersName" class="form-label">Nama Pengusul</label>
...
foreach ($data_rr as $val) {?>
    ...
    function save_rr() {
        ...
        if (id_rr == "" || judul_rapat == "" || tanggal_rapat == "" || keterangan == "" || jam_mulai == "" ||
            jam_selesai == "") {
            toastr.error('Woops Something Wrong.', 'Error Alert', {
                timeOut: 5000
            });
        } else {
