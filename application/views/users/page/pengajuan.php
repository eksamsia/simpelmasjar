                                        ...
                                        <div class="modal-content border-0">
                                            ...
                                            <div class="modal-body">
                                                <form id="form_input">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="mb-3">
                                                                <table style="width:100%">
                                                                    ...
                                                                    <tr>
                                                                        <td><label for="teammembersName" class="form-label"></label><span id="id_user"></span></td>
                                                                        <td><label for="teammembersName" class="form-label"></label><span id="id_kategori"></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td><label for="teammembersName" class="form-label"></label><span id="status_pemohon"></span></td>
                                                                            <td><label for="teammembersName" class="form-label"></label><span id="judul"></span></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td><label for="teammembersName" class="form-label"></label><span id="mulai_penelitian"></span></td>
                                                                            <td><label for="teammembersName" class="form-label"></label><span id="selesai_penelitian"></span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>Pejabat</th>
                                                                            <th>No. Surat</th>
                                                                        ...
                                                                        <tr>
                                                                            <td><label for="teammembersName" class="form-label"></label><span id="nama_pejabat"></span></td>
                                                                            <td><label for="teammembersName" class="form-label"></label><span id="no_surat"></span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>Alamat</th>
                                                                            <th>No. Whatsapp</th>
                                                                        ...
                                                                        <tr>
                                                                            <td><label for="teammembersName" class="form-label"></label><span id="alamat"></span></td>
                                                                            <td><label for="teammembersName" class="form-label"></label><span id="no_wa"></span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>Lokasi</th>
                                                                            <th>Lama Kegiatan</th>
                                                                        ...
                                                                        <tr>
                                                                            <td><label for="teammembersName" class="form-label"></label><span id="lokasi_kegiatan"></span></td>
                                                                            <td><label for="teammembersName" class="form-label"></label><span id="lama_kegiatan"></span></td>
                                                                        </tr>
                                                                    </tr>
                                                                </table>
                                                                <br>
                                                    ...
                                                    <div class="col-lg-12" id="tombol">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            <a href="" id="url_download" class="btn btn-success" title="Download"><i class="las la-print"></i> Download</a>
                                                            <button type="button" class="btn btn-info" onclick="download_surat()"><i class="las la-print"></i> Download Jquery</button>
