<!doctype html>
	<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="sm-hover" data-layout-mode="dark">

	<head>

		<meta charset="utf-8" />
		<title>e-Ruang Rapat | Kab.Nganjuk</title>
		...
		<!-- fullcalendar css -->
		<link href="<?= base_url()?>ruangrapat-assets/assets/libs/fullcalendar/main.min.css" rel="stylesheet" type="text/css" />

		<!-- jsvectormap css -->
		<link href="<?= base_url()?>ruangrapat-assets/assets/libs/jsvectormap/css/jsvectormap.min.css" rel="stylesheet" type="text/css" />

		<!--Swiper slider css-->
		<link href="<?= base_url()?>ruangrapat-assets/assets/libs/swiper/swiper-bundle.min.css" rel="stylesheet" type="text/css" />
		...
		<!-- Sweet Alert css-->
		<link href="<?= base_url()?>ruangrapat-assets/assets/libs/sweetalert2/sweetalert2.min.css" rel="stylesheet" type="text/css" />
			...
			<header id="page-topbar">
				<div class="layout-width">
						...
						<div class="d-flex">
							...
							<div class="navbar-brand-box horizontal-logo">
								<a href="index.html" class="logo logo-dark">
									...
									<span class="logo-lg">
										<img src="<?= base_url()?>ruangrapat-assets/assets/images/log.png" alt="" height="17">
									</span>
								</a>
					...
					<div class="d-flex align-items-center">
						...
						<div class="dropdown topbar-head-dropdown ms-1 header-item">
							<button type="button" class="btn btn-soft-secondary" id="btn-nonaktif"><?php echo $this->session->userdata('name');?></button>
				...
				<div class="dropdown ms-sm-3 header-item topbar-user">
					...
					<span class="d-flex align-items-center">
						<img class="rounded-circle header-profile-user" src="<?= base_url()?>ruangrapat-assets/assets/images/users/user-dummy-img.jpg"
						alt="Header Avatar">
					</span>
				</button>
