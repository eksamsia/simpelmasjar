<form action="" method="post" id="form_pembagian">
  <div class="modal-body form">
    ...
    <div class="row mb-2">
      ...
      <table class="tab_rumus">
        <tbody>
          <tr>
            <td colspan="5" class="fdet_rumusket">Keterangan</td>
          </tr>
          <tr>
            <td style="padding:5px 0px;">
              <div class="input-group">
                <input autocomplete="off" type="text" tabindex="1" class="numddgen persenabcd fdet_nameA form-control trig" id="inputA_1" name="inputA_1" value="71.97">
                <span class="fdet_rumusA input-group-addon"></span>
                <span class="input-group-addon input-group-addonauto"> - </span>
                <input autocomplete="off" type="text" tabindex="1" class="numddgen persenabcd fdet_nameB form-control trig" id="inputB_1" name="inputB_1" value="71.72">
                <span class="fdet_rumusB input-group-addon"></span>
              </div>
            </td>
            <td rowspan="2" class="smdg">=</td>
            <td rowspan="2">
              <div class="input-group">
                <input readonly="" autocomplete="off" type="text" class="numddgen fdet_nameD form-control trig" id="inputD_1" name="inputD_1" value="0.35">
                <span class="fdet_rumusD input-group-addon">%</span>
              </div>
            </td>
          </tr>
          <tr>
            <td style="padding:5px 0px;border-top:2px solid #1e5d21;">
              <div class="input-group">
                <input autocomplete="off" type="text" tabindex="1" class="numddgen persenabcd fdet_nameC form-control trig" id="inputC_1" name="inputC_1" value="71.72">
                <span class="fdet_rumusC input-group-addon"></span>
              </div>
            </td>
          </tr>
        </tbody>
